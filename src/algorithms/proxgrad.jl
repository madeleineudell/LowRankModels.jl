...
@inline function _updateGradX!(g::GLRM, XY::Matrix{Float64}, gx::Matrix{Float64})
...
@inline function _updateGradY!(g::GLRM, XY::Matrix{Float64}, gy::Matrix{Float64})
  yidxs = get_yidxs(g.losses)
...
function fit!(glrm::GLRM, params::ProxGradParams;
    ...
    # corresponding views of gx corresponding to each sample
